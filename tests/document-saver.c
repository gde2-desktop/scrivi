...
#define DEFAULT_LOCAL_URI "/tmp/scrivi-document-saver-test.txt"
#define DEFAULT_REMOTE_URI "sftp://localhost/tmp/scrivi-document-saver-test.txt"
#define DEFAULT_CONTENT "hello world!"
#define DEFAULT_CONTENT_RESULT "hello world!\n"

#define UNOWNED_LOCAL_DIRECTORY "/tmp/scrivi-document-saver-unowned"
#define UNOWNED_LOCAL_URI "/tmp/scrivi-document-saver-unowned/scrivi-document-saver-test.txt"

#define UNOWNED_REMOTE_DIRECTORY "sftp://localhost/tmp/scrivi-document-saver-unowned"
#define UNOWNED_REMOTE_URI "sftp://localhost/tmp/scrivi-document-saver-unowned/scrivi-document-saver-test.txt"

#define UNOWNED_GROUP_LOCAL_URI "/tmp/scrivi-document-saver-unowned-group.txt"
#define UNOWNED_GROUP_REMOTE_URI "sftp://localhost/tmp/scrivi-document-saver-unowned-group.txt"
...
static ScriviDocument *
create_document (const gchar *contents)
{
	ScriviDocument *document = scrivi_document_new ();
...
static void
complete_test_error (ScriviDocument *document,
                     GError        *error,
                     SaverTestData *data)
{
...
static void
complete_test (ScriviDocument *document,
               GError        *error,
               SaverTestData *data)
{
	test_completed = TRUE;
            ...
            SaverTestData            *data)
{
	...
	scrivi_document_set_newline_type (document, newline_type);
	...
	scrivi_document_save_as (document, uri, scrivi_encoding_get_utf8 (), save_flags);
...
static NewLineTestData newline_test_data[] = {
	...
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\r\nhello\r\nworld", "\nhello\nworld\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\r\nhello\r\nworld\r\n", "\nhello\nworld\n\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\rhello\rworld", "\nhello\nworld\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\rhello\rworld\r", "\nhello\nworld\n\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\nhello\r\nworld", "\nhello\nworld\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_LF, "\nhello\r\nworld\r", "\nhello\nworld\n\n"},
	...
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\r\nhello\r\nworld", "\r\nhello\r\nworld\r\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\r\nhello\r\nworld\r\n", "\r\nhello\r\nworld\r\n\r\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\rhello\rworld", "\r\nhello\r\nworld\r\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\rhello\rworld\r", "\r\nhello\r\nworld\r\n\r\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\nhello\r\nworld", "\r\nhello\r\nworld\r\n"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR_LF, "\nhello\r\nworld\r", "\r\nhello\r\nworld\r\n\r\n"},
	...
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\r\nhello\r\nworld", "\rhello\rworld\r"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\r\nhello\r\nworld\r\n", "\rhello\rworld\r\r"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\rhello\rworld", "\rhello\rworld\r"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\rhello\rworld\r", "\rhello\rworld\r\r"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\nhello\r\nworld", "\rhello\rworld\r"},
	{SCRIVI_DOCUMENT_NEWLINE_TYPE_CR, "\nhello\r\nworld\r", "\rhello\rworld\r\r"}
};

static void
test_new_line (const gchar *filename, ScriviDocumentSaveFlags save_flags)
{
	gint i;
...
static void
check_permissions_saved (ScriviDocument *document,
                         GError        *error,
                         SaverTestData *data)
{
	guint permissions = (guint)GPOINTER_TO_INT (data->data);
	GFile *file = scrivi_document_get_location (document);
...
static void
test_unowned_group_permissions (ScriviDocument *document,
                                GError        *error,
                                SaverTestData *data)
{
