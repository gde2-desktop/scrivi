...
# generate-plugin.py - scrivi plugin skeletton generator
...
HELP = USAGE + """
generate skeleton source tree for a new scrivi plugin.
...
output_files = {
    ...
    'scrivi-plugin.desktop.in': '%s/%s.scrivi-plugin.desktop.in' % (plugin_module, plugin_module)
}

if options['language'] == 'c':
    output_files['scrivi-plugin.c'] = '%s/%s-plugin.c' % (plugin_module, plugin_module)
    output_files['scrivi-plugin.h'] = '%s/%s-plugin.h' % (plugin_module, plugin_module)
else:
