...
struct _ScriviTextRegion {
	GtkTextBuffer *buffer;
	GList         *subregions;
	guint32        time_stamp;
};

typedef struct _ScriviTextRegionIteratorReal ScriviTextRegionIteratorReal;

struct _ScriviTextRegionIteratorReal {
...
/* Find and return a subregion node which contains the given text
   ...
   subregion */
static GList * 
find_nearest_subregion (ScriviTextRegion     *region,
...
ScriviTextRegion *
scrivi_text_region_new (GtkTextBuffer *buffer)
{
	ScriviTextRegion *region;

	g_return_val_if_fail (buffer != NULL, NULL);

	region = g_new (ScriviTextRegion, 1);
...
void 
scrivi_text_region_destroy (ScriviTextRegion *region, gboolean delete_marks)
{
...
GtkTextBuffer *
scrivi_text_region_get_buffer (ScriviTextRegion *region)
{
...
static void
scrivi_text_region_clear_zero_length_subregions (ScriviTextRegion *region)
{
...
void 
scrivi_text_region_add (ScriviTextRegion     *region,
		     ...
		     const GtkTextIter *_end)
{
	...
	DEBUG (g_print ("---\n"));
	DEBUG (scrivi_text_region_debug_print (region));
...
void 
scrivi_text_region_subtract (ScriviTextRegion     *region,
			  const GtkTextIter *_start,
			  const GtkTextIter *_end)
{
	...
	scrivi_text_region_clear_zero_length_subregions (region);

	DEBUG (scrivi_text_region_debug_print (region));
}

gint 
scrivi_text_region_subregions (ScriviTextRegion *region)
{
...
gboolean 
scrivi_text_region_nth_subregion (ScriviTextRegion *region,
			       guint          subregion,
			       GtkTextIter   *start,
			       GtkTextIter   *end)
{
...
ScriviTextRegion * 
scrivi_text_region_intersect (ScriviTextRegion     *region,
			   const GtkTextIter *_start,
			   const GtkTextIter *_end)
{
	GList *start_node, *end_node, *node;
	...
	new_region = scrivi_text_region_new (region->buffer);
	done = FALSE;
...
static gboolean 
check_iterator (ScriviTextRegionIteratorReal *real)
{
	if ((real->region == NULL) ||
...
void       
scrivi_text_region_get_iterator (ScriviTextRegion         *region,
                              ScriviTextRegionIterator *iter,
                              guint                  start)
{
	ScriviTextRegionIteratorReal *real;

	g_return_if_fail (region != NULL);
	g_return_if_fail (iter != NULL);	

	real = (ScriviTextRegionIteratorReal *)iter;
...
gboolean
scrivi_text_region_iterator_is_end (ScriviTextRegionIterator *iter)
{
	ScriviTextRegionIteratorReal *real;
...
gboolean
scrivi_text_region_iterator_next (ScriviTextRegionIterator *iter)
{
	ScriviTextRegionIteratorReal *real;
...
void       
scrivi_text_region_iterator_get_subregion (ScriviTextRegionIterator *iter,
					GtkTextIter           *start,
					GtkTextIter           *end)
{
	ScriviTextRegionIteratorReal *real;
...
void 
scrivi_text_region_debug_print (ScriviTextRegion *region)
{
	GList *l;
