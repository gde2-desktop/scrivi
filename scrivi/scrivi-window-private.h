...
#ifndef __SCRIVI_WINDOW_PRIVATE_H__
#define __SCRIVI_WINDOW_PRIVATE_H__
...
/* WindowPrivate is in a separate .h so that we can access it from scrivi-commands */

struct _ScriviWindowPrivate
{
	GtkWidget      *notebook;
	...
	GtkWidget      *menubar;
	ScriviToolbarSetting toolbar_style;
...
#endif  /* __SCRIVI_WINDOW_PRIVATE_H__  */
