...
/*
 * Modified by the scrivi Team, 2007. See the AUTHORS file for a
...
static void
add_scrivi_styles_path (GtkSourceStyleSchemeManager *mgr)
{
	gchar *dir;

	dir = get_scrivi_styles_path();
...
GSList *
scrivi_style_scheme_manager_list_schemes_sorted (GtkSourceStyleSchemeManager *manager)
{
...
gboolean
_scrivi_style_scheme_manager_scheme_is_scrivi_user_scheme (GtkSourceStyleSchemeManager *manager,
...
/**
 * _scrivi_style_scheme_manager_install_scheme:
 * @manager: a #GtkSourceStyleSchemeManager
 * @fname: the file name of the style scheme to be installed
 *
 * Install a new user scheme.
 * This function copies @fname in #SCRIVI_STYLES_DIR and ask the style manager to
 ...
 */
const gchar *
_scrivi_style_scheme_manager_install_scheme (GtkSourceStyleSchemeManager *manager,
					    const gchar                 *fname)
{
	...
	styles_dir = get_scrivi_styles_path();
	...
	if (strcmp (dirname, styles_dir) != 0)
	{
		...
		/* Copy the style scheme file into SCRIVI_STYLES_DIR */
	...
	while (*ids != NULL)
	{
		...
		scheme = gtk_source_style_scheme_manager_get_scheme (
				scrivi_get_style_scheme_manager (), *ids);
...
/**
 * _scrivi_style_scheme_manager_uninstall_scheme:
 * @manager: a #GtkSourceStyleSchemeManager
 ...
 */
gboolean
_scrivi_style_scheme_manager_uninstall_scheme (GtkSourceStyleSchemeManager *manager,
					      const gchar                 *id)
{
	GtkSourceStyleScheme *scheme;
	const gchar *filename;
