...
/*
 * Modified by the scrivi Team, 2003-2006. See the AUTHORS file for a 
...
scrivi_get_language_manager (void)
{
...
GSList *
scrivi_language_manager_list_languages_sorted (GtkSourceLanguageManager *lm,
