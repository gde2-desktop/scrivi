...
void _scrivi_cmd_help_contents(GtkAction* action, ScriviWindow* window)
{
	scrivi_debug(DEBUG_COMMANDS);

	scrivi_help_display(GTK_WINDOW(window), NULL, NULL);
}

void _scrivi_cmd_help_about(GtkAction* action, ScriviWindow* window)
{
	...
	static const gchar comments[] = \
		N_("Scrivi is a small and lightweight text editor for the GDE2 Desktop");
