...
struct _ScriviSpellLanguageDialog 
{
	GtkDialog dialog;
...
G_DEFINE_TYPE(ScriviSpellLanguageDialog, scrivi_spell_language_dialog, GTK_TYPE_DIALOG)


static void 
scrivi_spell_language_dialog_class_init (ScriviSpellLanguageDialogClass *klass)
{
...
language_row_activated (GtkTreeView *tree_view,
			...
			ScriviSpellLanguageDialog *dialog)
{
	gtk_dialog_response (GTK_DIALOG (dialog), GTK_RESPONSE_OK);
}

static void
create_dialog (ScriviSpellLanguageDialog *dlg,
...
static void
scrivi_spell_language_dialog_init (ScriviSpellLanguageDialog *dlg)
{
	
}

static void
populate_language_list (ScriviSpellLanguageDialog        *dlg,
			const ScriviSpellCheckerLanguage *cur_lang)
{
	...
	while (langs)
	{
		...
		name = scrivi_spell_checker_language_to_string ((const ScriviSpellCheckerLanguage*)langs->data);
...
GtkWidget *
scrivi_spell_language_dialog_new (GtkWindow                       *parent,
				 const ScriviSpellCheckerLanguage *cur_lang,
				 const gchar *data_dir)
{
	ScriviSpellLanguageDialog *dlg;

	g_return_val_if_fail (GTK_IS_WINDOW (parent), NULL);

	dlg = g_object_new (SCRIVI_TYPE_SPELL_LANGUAGE_DIALOG, NULL);
...
scrivi_spell_language_get_selected_language (ScriviSpellLanguageDialog *dlg)
{
	...
	lang = (const ScriviSpellCheckerLanguage* ) g_value_get_pointer (&value);
