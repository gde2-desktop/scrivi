...
#include "scrivi-changecase-plugin.h"
...
#define WINDOW_DATA_KEY "ScriviChangecasePluginWindowData"

SCRIVI_PLUGIN_REGISTER_TYPE(ScriviChangecasePlugin, scrivi_changecase_plugin)
...
static void
change_case (ScriviWindow      *window,
...
static void
scrivi_changecase_plugin_init (ScriviChangecasePlugin *plugin)
{
	scrivi_debug_message (DEBUG_PLUGINS, "ScriviChangecasePlugin initializing");
}

static void
scrivi_changecase_plugin_finalize (GObject *object)
{
	G_OBJECT_CLASS (scrivi_changecase_plugin_parent_class)->finalize (object);

	scrivi_debug_message (DEBUG_PLUGINS, "ScriviChangecasePlugin finalizing");
}
		...
		WindowData   *data)
{
	...
	view = GTK_TEXT_VIEW (scrivi_window_get_active_view (window));
	       ...
	       ScriviWindow *window)
{
	...
	data->action_group = gtk_action_group_new ("ScriviChangecasePluginActions");
...
static void
scrivi_changecase_plugin_class_init (ScriviChangecasePluginClass *klass)
{
	GObjectClass *object_class = G_OBJECT_CLASS (klass);
	ScriviPluginClass *plugin_class = SCRIVI_PLUGIN_CLASS (klass);

	object_class->finalize = scrivi_changecase_plugin_finalize;
