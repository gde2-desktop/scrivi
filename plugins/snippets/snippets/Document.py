...
class Document:
        ...
        def env_get_documents_uri(self, buf):
                ...
                if isinstance(toplevel, scrivi.Window):
        ...
        def env_get_documents_path(self, buf):
                ...
                if isinstance(toplevel, scrivi.Window):
                        ...
                        documents_path = [location.get_path()
                                          ...
                                          if scrivi.utils.uri_has_file_scheme(location.get_uri())]
                else:
                        documents_path = []
        ...
        def update_environment(self):
                ...
                variables = {'SCRIVI_SELECTED_TEXT': self.env_get_selected_text, 
                             'SCRIVI_CURRENT_WORD': self.env_get_current_word, 
                             'SCRIVI_CURRENT_LINE': self.env_get_current_line,
                             'SCRIVI_CURRENT_LINE_NUMBER': self.env_get_current_line_number,
                             'SCRIVI_CURRENT_DOCUMENT_URI': self.env_get_document_uri, 
                             'SCRIVI_CURRENT_DOCUMENT_NAME': self.env_get_document_name,
                             'SCRIVI_CURRENT_DOCUMENT_SCHEME': self.env_get_document_scheme,
                             'SCRIVI_CURRENT_DOCUMENT_PATH': self.env_get_document_path,
                             'SCRIVI_CURRENT_DOCUMENT_DIR': self.env_get_document_dir,
                             'SCRIVI_CURRENT_DOCUMENT_TYPE': self.env_get_document_type,
                             'SCRIVI_DOCUMENTS_URI': self.env_get_documents_uri,
                             'SCRIVI_DOCUMENTS_PATH': self.env_get_documents_path,
                             }
        ...
        def uses_current_word(self, snippet):
                matches = re.findall('(\\\\*)\\$SCRIVI_CURRENT_WORD', snippet['text'])
        ...
        def uses_current_line(self, snippet):
                matches = re.findall('(\\\\*)\\$SCRIVI_CURRENT_LINE', snippet['text'])
        ...
        def apply_uri_snippet(self, snippet, mime, uri):
                ...
                if scrivi.utils.uri_has_file_scheme(uri):
                ...
                os.environ['SCRIVI_DROP_DOCUMENT_URI'] = uri
                os.environ['SCRIVI_DROP_DOCUMENT_NAME'] = name
                os.environ['SCRIVI_DROP_DOCUMENT_SCHEME'] = scheme
                os.environ['SCRIVI_DROP_DOCUMENT_PATH'] = pathname
                os.environ['SCRIVI_DROP_DOCUMENT_DIR'] = dirname
                os.environ['SCRIVI_DROP_DOCUMENT_TYPE'] = mime
                ...
                os.environ['SCRIVI_DROP_DOCUMENT_RELATIVE_PATH'] = relpath
