...
class WindowHelper:
        ...
        def run(self, window):
                ...
                for view in self.window.get_views():
                        if isinstance(view, scrivi.View) and not self.has_controller(view):
        ...
        def stop(self):
                ...
                for view in self.window.get_views():
                        if isinstance(view, scrivi.View) and self.has_controller(view):
        ...
        def register_messages(self):
                ...
                self.messages = {
                        'activate': bus.register('/plugins/snippets', 'activate', ('view', 'iter'), trigger=str, view=scrivi.View, iter=gtk.TextIter),
                        'parse-and-activate': bus.register('/plugins/snippets', 'parse-and-activate', ('view', 'iter'), snippet=str, view=scrivi.View, iter=gtk.TextIter)
                }
        ...
        def insert_menu(self):
                ...
                self.action_group = gtk.ActionGroup("ScriviSnippetPluginActions")
                self.action_group.set_translation_domain('scrivi')
        ...
        def on_tab_added(self, window, tab):
                # Create a new controller for this tab if it has a standard scrivi view
                view = tab.get_view()
