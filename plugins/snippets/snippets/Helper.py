...
def insert_with_indent(view, piter, text, indentfirst = True, context = None):
        ...
        view.get_buffer().set_data('ScriviSnippetsPluginContext', context)
        ...
        view.get_buffer().set_data('ScriviSnippetsPluginContext', None)

def get_buffer_context(buf):
        return buf.get_data('ScriviSnippetsPluginContext')
