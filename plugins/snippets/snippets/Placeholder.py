...
class PlaceholderEval(PlaceholderExpand):
        ...
        # potentially block scrivi if you have a placeholder which gets stuck,
        ...
        def expand(self, text):
                ...
                if 'process_snippet' in self.namespace:
                        try:
                                ...
                                # scrivi doesn't get freezed by someone creating a python
                                # placeholder which for instance loops indefinately. Since
                                # the code is executed synchronously it will hang scrivi. With
